...
function string.IsPNG(bytes)
    return bytes:sub(1, 8) == ID_PNG
end

function string.IsJPG(bytes)
    return bytes:sub(1, 2) == ID_JPG
end

function string.IsVTF(bytes)
    return bytes:sub(1, 4) == ID_VTF
end
