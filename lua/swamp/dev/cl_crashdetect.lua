    ...
    if lastcrash then
        timer.Simple(0.1, function()
            ...
            local function plural(x,st)
                if x==1 then return x..st else return x..st.."s" end
            end
            ...
            vgui("DFrame", function(p)
                ...
                for i,line in ipairs({"It looks like your game crashed last time you played ("..delta.." ago).",
                "If so, please send a crash report to help us fix it.", 
                "If you send a crash report, you may optionally include comments below:",
                "BUTTONS",
                "Don't send a crash report if your game closed for another reason (eg. power outage).",
                "If you keep crashing, try disabling playermodel downloads and the\n  \"turbo button\" in the tab menu. If you still crash, ask for help."
                }) do
                    ...
                    if line=="BUTTONS" then
                        ...
                        vgui("DPanel", function(p)
                            ...
                            vgui("DButton", function(p)
                                ...
                                p.DoClick = function() popup:Close() end
                            end)
                        end)
