...
ui = Memo(function(classname)
    if ispanel(classname) then return nil, function(...) return update_panel(classname, ...) end end -- nil first return means dont cache
...
--     end
-- })
-- -- this is just here so the context is correct in panel:Init. Maybe we should override the control table instead?
