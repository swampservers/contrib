...
net.Receive("DonationBoxPoints", function()
    ...
    vgui("DFrame", function(p)
        ...
        vgui("DLabel", function(p)
            ...
            p:SetText([[ Donald Trump is raising points to fight the Radical Far Left Democrats,
 ...
 Contribute now! The top 10 donors will have the exclusive honor of
        ...
        vgui("DLabel", function(p)
            p:SetContentAlignment(5)
            -- p:SetColor(color_black)
            p:SetText([[(disclaimer: this is not a donation to the real-world Donald Trump
