...
function ENT:Initialize()
    ...
    if CLIENT then
        self:SetRenderBounds(Vector(-100, -100, -100), Vector(100, 100, 50))
    end
end
...
function ENT:AcceptInput(input, activator, caller, data)
    if input == "TurnOn" then
        ...
        self:EmitSound("ambient/energy/electric_loop.wav", 60)

        return true
    end

    if input == "TurnOff" then
        self:SetZapping(false)
...
local beamtargets = {Vector(-2294, -47, -208), Vector(-2294, -47, -224), Vector(-2294, -47, -240), Vector(-2294, -47, -256), Vector(-2294, -47, -272), Vector(-2294, -113, -208), Vector(-2294, -113, -224), Vector(-2294, -113, -240), Vector(-2294, -113, -256), Vector(-2294, -113, -272), Vector(-2271, -60, -217), Vector(-2271, -60, -230), Vector(-2271, -60, -243), Vector(-2271, -100, -217), Vector(-2271, -100, -230), Vector(-2271, -100, -243), Vector(-2263, -80, -208), Vector(-2263, -80, -221), Vector(-2263, -80, -234)}
