...
function AddSnow()
    ...
    Material("swamp_minigolf/golf_concretefloor016a"):SetTexture("$basetexture", "nature/snowfloor001a")
    Material("CONCRETE/CONCRETEFLOOR023A"):SetTexture("$basetexture", "nature/snowfloor001a")
    Material("swamponions/ground/blendgravelconcrete"):SetTexture("$basetexture", "nature/snowfloor002a")
    Material("swamponions/ground/blendgravelconcrete"):SetTexture("$basetexture2", "nature/snowfloor001a")
    ...
    Material("maps/" .. game.GetMap() .. "/metal/metalroof006a_2584_2300_-671"):SetTexture("$basetexture", "nature/snowfloor002a")
    Material("maps/" .. game.GetMap() .. "/metal/metalroof006a_-10240_-2904_-6528"):SetTexture("$basetexture", "nature/snowfloor002a")
    ...
    Material("building_template/building_template028a"):SetTexture("$basetexture", "nature/snowfloor002a")
    ...
    Material("nature/blendgrassgravel002a"):SetTexture("$basetexture", "nature/snowfloor001a")
    Material("nature/blendgrassgravel002a"):SetTexture("$basetexture2", "nature/snowfloor002a")
    Material("nature/blendsandsand008a"):SetTexture("$basetexture", "nature/snowfloor003a")
    Material("nature/blendsandsand008a"):SetTexture("$basetexture2", "nature/snowfloor002a")
    Material("swamp_minigolf/golf_blendsandsand008a"):SetTexture("$basetexture", "nature/snowfloor003a")
    Material("swamp_minigolf/golf_blendsandsand008a"):SetTexture("$basetexture2", "nature/snowfloor002a")
    Material("nature/blendrocksand004a"):SetTexture("$basetexture", "nature/snowfloor002a")
    Material("nature/blendrocksand004a"):SetTexture("$basetexture2", "nature/snowfloor003a")
    Material("swamponions/ground/grass_brush"):SetTexture("$basetexture", "nature/snowfloor002a")
    --Material("swamp_minigolf/golf_grass_brush"):SetTexture("$basetexture", "nature/snowfloor002a")
    ...
    Material("maps/" .. game.GetMap() .. "/concrete/concretefloor038c_2584_2300_-671"):SetTexture("$basetexture", "nature/snowfloor002a")
    --golf border
