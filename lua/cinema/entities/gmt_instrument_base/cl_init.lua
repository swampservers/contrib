...
SynthesizerInstruments = {"Synthesizer", "eguitar", "Guitar", "Harp", "Organ", "Piano", "Sax", "Violin"}
...
ENT.BrowserHUD = {
    URL = "https://www.gmtower.org/apps/instruments/piano.php",
