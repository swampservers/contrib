...
SWEP.VElements = {
	["d3ammo"] = { type = "Quad", bone = "bone001", rel = "", pos = Vector(3.7, -4.76, -.01), angle = Angle(90, 0, -10), size = .018, draw_func = nil},
	["d3ammoclip"] = { type = "Quad", bone = "bone001", rel = "", pos = Vector(3.85, -5.725, -.4), angle = Angle(90, 0, -10), size = .038, draw_func = nil},
	["bfgcharge"] = { type = "Quad", bone = "bone001", rel = "", pos = Vector(3.45, -3.4, -.625), angle = Angle(90, 0, -10), size = .0095, draw_func = nil}
}
