...
if ScrW()/ScrH() > 1920/1200 then imgh=imgh*(ScrW()/ScrH())/(1920/1200) end

local sizeplus=0.1
if not LocalPlayer():InVehicle() then surface.DrawTexturedRectUV(((imgh*1920/1200)-ScrW())/-2, (imgh-ScrH())/-2,imgh*1920/1200,imgh,0+sizeplus,0+sizeplus,1-sizeplus,1-sizeplus) end
