...
function SWEP:PrimaryAttack()
	...
	if CLIENT then
		if PropTrashLookedAt then
			...
			net.WriteTable({ent=PropTrashLookedAt,act=TRASHACT_PAINT,hitpos=PropTrashLookedAtPos,color=TrashPaintColor})
			net.SendToServer()
		end
	end
end
...
function SWEP:SecondaryAttack()
	...
	if CLIENT then
		if PropTrashLookedAt then
			net.Start("TrashAction")
			net.WriteTable({ent=PropTrashLookedAt,act=TRASHACT_UNPAINT,hitpos=PropTrashLookedAtPos})
			net.SendToServer()
		end
	end
end
