...
SS_AccessoryItem({
    ...
    GetDescription = function(self) return "You can wear it\n\nBETA - Oversized props may be removed" end,
...
if SERVER then
    ...
    for i = 1, 50 do
        table.insert(props, GetSandboxProp(accessoryradius))
    end

    net.Start("RunLuaLong")
    net.WriteString("SetClipboardText([[ " .. util.TableToJSON(props) .. " ]])")
    net.Send(ME())
end
