...
SS_PaintTileInset = function(pnl, w, h)
    ...
    surface.DrawRect(0, 0, w, h)
    surface.SetDrawColor(MenuTheme_FG)
    surface.DrawRect(SS_COMMONMARGIN, SS_COMMONMARGIN, w-SS_COMMONMARGIN*2, h-SS_COMMONMARGIN*2)
end

SS_PaintMD = function(pnl, w, h)
    surface.SetDrawColor(MenuTheme_MD)
    surface.DrawRect(0, 0, w, h)
end
...
SS_PaintShaded = function(pnl, w, h)
        surface.SetDrawColor(Color(0, 0, 0, 100))
        surface.DrawRect(0, 0, w, h)
end
