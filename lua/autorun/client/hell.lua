...
function HellPromptPlayer()
	...
	function HellPanel:Paint(w,h)
		...
		draw.DrawText("The Hell theater allows the following content:","HellPrompt",w*.5-235,h*.5-95,Color(192,192,192),TEXT_ALIGN_LEFT)
		draw.DrawText("-Torture footage, except for illegal-to-distribute animal crush videos.","HellPrompt",w*.5-235,h*.5-75,Color(192,192,192),TEXT_ALIGN_LEFT)
