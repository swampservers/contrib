...
if CLIENT then
    ...
    function PANEL:Init()
        ...
        self.mapList.PaintOver = function(ml)
            for _, v in ipairs( ml:GetCanvas():GetChildren() ) do
                if v.PaintOver2 then v:PaintOver2() end
            end
    ...
    function PANEL:SetMaps(maps)
        ...
        for k, v in ipairs(maps) do
            ...
            button.ID = k
            button:SetText(k==1 and "Keep playing current map" or v)
            ...
            if k==1 then button:DoClick() end
            
            do
                local Paint = button.Paint
                button.Paint = function(s, w, h)
                    if not PAINTING2 then
                ...
                button.PaintOver2 = function(s, w, h)
                    -- PAINTING2 = true
                    s:PaintAt(s:LocalToScreen(0,0))
                    -- PAINTING2 = false
                end
            end
