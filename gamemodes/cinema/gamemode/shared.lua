...
local function cl_file(fn) include(fn) end
local function sh_file(fn) include(fn) end
local function sv_file(fn) end

if SERVER then
    cl_file = function(fn) AddCSLuaFile(fn) end
    sh_file = function(fn) AddCSLuaFile(fn) include(fn) end
    sv_file = function(fn) include(fn) end
end
